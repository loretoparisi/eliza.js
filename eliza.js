...
/////////////////////////////
// modified by Loreto Parisi 2019
/////////////////////////////
...
// Keys
var maxKey = 36;
var keyNotFound = maxKey - 1;
var keyword = new Array(maxKey);
...
var maxrespnses = 116;
var response = new Array(maxrespnses);
...
// Function to pad a string.. head, tail and punctuation
var punct = new Array(".", ",", "!", "?", ":", ";", "&", '"', "@", "#", "(", ")")
...
var chatmax = 5; // number of lines / 2
var chatpoint = 0;
var chatter = new Array(chatmax);
...
function write_ln(line) {
    if(typeof line != 'undefined') document.Eliza.log.value += line
}
function write() {
